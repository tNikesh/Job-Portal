...
export default function page() {
  ...
  } = useForm<EmployerFormData>({defaultValues:{
    company_name: "",
  company_website: "",
  company_description: "",
  contact_person: "",
  ...
  useEffect(() => {
    api.get("/employer/profile/detail")
      .then((res) => {
  ...
  const onSubmit = async (data: EmployerFormData) => {
    ...
    try {
      const res = await api.patch("/employer/profile/detail", data);
  ...
  {loading?<Skeleton/>:(
    ...
    <form
      ...
      className="w-full text-left mx-auto space-y-10 bg-white shadow-sm p-10 border border-gray-100"
      noValidate
    >
      <h1 className="text-xl font-semibold text-center ">Edit Employer Deatils</h1>
